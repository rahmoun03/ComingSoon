...
export default function RockPath({ rockCount = 300, spread = 8 }) {
	...
	useFrame(({camera, clock }) => {
		...
		rocks.forEach((rock, i) => {
			...
			if (dist > 50) {
				// Hide rock by scaling to 0
				dummy.position.set(9999, 9999, 9999) // OR use offscreen position
