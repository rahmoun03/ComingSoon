  ...
  return (
    <section className="relative h-svh md:h-screen w-full flex flex-col md:flex-row bg-black/50 overflow-hidden">
      ...
      >
        ...
        <motion.div
          className="w-full flex flex-col justify-center items-center md:items-start font-[JetBrains] gap-4 text-center md:text-left"
          initial="hidden"
          animate="show"
          variants={{
            hidden: {},
        ...
        >
          {t('nove.quotes', { returnObjects: true }).map((line, i) => (
            <motion.p
              key={i}
